...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    try {
        ...
        try {
            ...
            echo json_encode([
                "success" => true,
                "message" => "Your message was sent, but we couldn't send a confirmation email to your address. Error: " . $e->getMessage()
            ]);
        }

    } catch (Exception $e) {
        echo json_encode(["success" => false, "message" => "Message could not be sent. API Error: " . $e->getMessage()]);
    }
} else {
