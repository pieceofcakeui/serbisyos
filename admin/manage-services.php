...
<head>
    ...
    <title>Manage Auto Repair Services</title>
...
<body>
        ...
        <div class="content flex-grow-1">
            ...
            <div class="container-fluid">
                <div class="page-header d-flex justify-content-between align-items-center mb-4">
                    <h1 style="margin-top: 30px;">Manage Services</h1>
                    ...
                    <?php foreach ($data as $category): ?>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingCat<?php echo $category['id']; ?>">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCat<?php echo $category['id']; ?>" aria-expanded="false" aria-controls="collapseCat<?php echo $category['id']; ?>">
                            ...
                            <div id="collapseCat<?php echo $category['id']; ?>" class="accordion-collapse collapse" aria-labelledby="headingCat<?php echo $category['id']; ?>" data-bs-parent="#mainAccordion">
                                <div class="accordion-body">
                                    <div class="accordion" id="subAccordion<?php echo $category['id']; ?>">
                                        <?php if (!empty($category['subcategories'])): ?>
                                            <?php foreach ($category['subcategories'] as $subcategory): ?>
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingSub<?php echo $subcategory['id']; ?>">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSub<?php echo $subcategory['id']; ?>" aria-expanded="false" aria-controls="collapseSub<?php echo $subcategory['id']; ?>">
                                                    ...
                                                    <div id="collapseSub<?php echo $subcategory['id']; ?>" class="accordion-collapse collapse" aria-labelledby="headingSub<?php echo $subcategory['id']; ?>" data-bs-parent="#subAccordion<?php echo $category['id']; ?>">
                                                        <div class="accordion-body">
                                                            <ul class="list-group">
                                                                <?php if (!empty($subcategory['services'])): ?>
                                                                    <?php foreach ($subcategory['services'] as $service): ?>
                                                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                                                            ...
                                                                            <div class="btn-group gap-1">
                                                                                <button class="btn btn-info btn-sm" onclick="prepareServiceModal('edit', '<?php echo $subcategory['id']; ?>', '<?php echo $service['id']; ?>', '<?php echo htmlspecialchars(addslashes($service['name'])); ?>', '<?php echo htmlspecialchars(addslashes($service['query_term'])); ?>')">
                                                                                    <i class="fas fa-edit"></i><span class="btn-label"></span>
                                                                                </button>
                                            ...
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <p>No subcategories found. Click 'Add Subcategory' to start.</p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="categoryModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="backend/manage_services.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="categoryIcon" class="form-label">Font Awesome Icon Class (e.g., fa-cogs)</label>
            ...
            <div class="modal-content">
                <form action="backend/manage_services.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="queryTerm" class="form-label">Query Term</label>
                            <input type="text" class="form-control" id="queryTerm" name="query_term" placeholder="Keywords para sa pag-search (e.g., Oil Change & Car)" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            ...
            <div class="modal-content">
                <form action="backend/manage_services.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-danger">This action cannot be undone. Deleting a category or subcategory will not delete its children.</p>
                    </div>
                    <div class="modal-footer">
    ...
    <script>
        ...
        function prepareCategoryModal(mode, id = '', name = '', icon = '', order = '10') {
        ...
        function prepareServiceModal(mode, parentSubcatId, serviceId = '', name = '', query = '') {
            ...
            if (mode === 'add') {
                ...
                form.querySelector('#queryTerm').value = query;
            }
            serviceModal.show();
        }
