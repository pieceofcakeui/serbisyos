    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.messages && response.messages.length > 0) {
                ...
                $('#messageContainer').html('<div class="text-center text-muted py-3">No messages yet. Start the conversation!</div>');
            }
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            ...
            $('#messageContainer').html('<div class="text-center text-danger py-3">Error: Could not load messages.</div>');
        }
    });
}
